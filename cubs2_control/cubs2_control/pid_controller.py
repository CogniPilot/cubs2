...
def pid_controller() -> Model:
    ...
    ail_out = _saturate(
        (
            m.Kp_roll.sym * e_roll
            + m.Ki_roll.sym * m.i_roll.sym
    ...
    elev_out = _saturate(
        (
            m.Kp_pitch.sym * e_pitch
            + m.Ki_pitch.sym * m.i_pitch.sym
    ...
    thr_out = _saturate(
        (
            m.Kp_speed.sym * e_speed
            + m.Ki_speed.sym * m.i_speed.sym
