        ...
        for obj in y.get("generic", []):
            ...
            self.generic.append(
                GenericModel(
                    ...
                    rpy=rpy_rad,
                    scale=tuple(float(x) for x in obj.get("scale", (1.0, 1.0, 1.0))),
                    color=tuple(float(x) for x in obj.get("color", (1.0, 1.0, 1.0))),
        ...
        for g in y.get("gates", []):
            ...
            self.gates.append(
                Gate(
                    ...
                    scale=tuple(float(x) for x in g.get("scale", (1.0, 1.0, 1.0))),
                )
            )
