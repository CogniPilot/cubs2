...
AVAILABLE_BAGS = [
    {
        ...
        "url": "https://drive.google.com/uc?export=download&id=11ourp5eBdvDx2e9HdO3fB2hCIJbOixIK",
    ...
    },
    {
        ...
        "url": "https://drive.google.com/uc?export=download&id=1zlkt57-Os6wgQ9rdz4i36VClBskRT2Fo",
...
Examples:
  ...
  %(prog)s cub_*.mcap                      # Download files matching pattern
    ...
    parser.add_argument("--list", "-l", action="store_true", help="List all available rosbag files")
    parser.add_argument(
        "--all", "-a", action="store_true", help="Download all available rosbag files"
    )
    parser.add_argument(
        "--output-dir",
        "-o",
    ...
    if args.all:
        ...
        for item in args.files:
            ...
            try:
                ...
                matches = [bag for bag in AVAILABLE_BAGS if fnmatch.fnmatch(bag["filename"], item)]
                if matches:
        ...
        print(
            "No files specified. Use --list to see available files or --all to download everything."
        )
        parser.print_help()
        return 1
